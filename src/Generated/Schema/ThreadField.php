...
/**
 * The ThreadField entity, as the XenForo API returns it.
 *
 ...
 */
final class ThreadField implements \JsonSerializable
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->filter_enabled = Cast::bool($data['filter_enabled'] ?? null);
        $this->search_enabled = Cast::bool($data['search_enabled'] ?? null);
    }
