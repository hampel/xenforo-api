 ...
 * endpoint either - versions are listed against their resource, ResourceItems::versions(),
 ...
 */
final class ResourceVersions extends Resource
{
     ...
     * ResourceItems does: a local resource wants a `version_attachment_key`, an external
